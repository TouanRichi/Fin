...
HD_PWD='C:/Users/Dat Pham/Downloads/Source/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_Sha_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISC_Sha_tb.tcl -notrace
