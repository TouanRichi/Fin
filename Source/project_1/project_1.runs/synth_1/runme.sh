...
HD_PWD='C:/Users/Dat Pham/Downloads/Source/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_Sha_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_Sha_tb.tcl
